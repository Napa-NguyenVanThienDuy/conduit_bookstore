...
const articleReducer = (state = initState, action) => {
  switch (action.type) {
    ...
    case LOAD_ARTICLE: {
      ...
      //console.log("tag re", cloneState.tabs.defaultTab);
    ...
    case LOAD_ARTICLE_LOGIN: {
      const { payload } = action;
      const cloneState = { ...state };
      //cloneState.pagination = payload.pagination;
      cloneState.tabs.defaultTab = payload;
      cloneState.isLoading = false;
      if (payload.includes("Your Feed") || payload.includes("Global Feed")) {
